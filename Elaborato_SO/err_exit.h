...
/// @file err_exit.h
/// @brief contains variables and functions definition for errno errors management

#ifndef ELABORATO_SO_ERR_EXIT_H
#define ELABORATO_SO_ERR_EXIT_H
